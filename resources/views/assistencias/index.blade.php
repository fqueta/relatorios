...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12 text-right mb-3">
      <a href="{{ route('assistencias.create') }}" class="btn btn-success"> Novo user </a>
    </div>
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          <table class="table dtr-inline table-hover">
            <thead>
              <tr>
                <th>#</th>
                <th>Ano</th>
              ...
              @foreach($assistencias as $key => $assistencia)
                <tr>
                  ...
                  <td class="text-center d-flex">
                    ...
                    <form action="{{ route('assistencias.destroy',['id'=>$assistencia->id]) }}" method="POST">
                      @csrf
                      @method('DELETE')
